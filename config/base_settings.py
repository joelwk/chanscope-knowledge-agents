...
def get_base_settings() -> Dict[str, Any]:
    ...
    _settings_cache = {
        ...
        'model': {
            ...
            'openrouter_api_base': os.getenv('OPENROUTER_API_BASE', '').strip(),
            'openrouter_model': os.getenv('OPENROUTER_MODEL', '').strip(),
            'openrouter_chunk_model': os.getenv('OPENROUTER_CHUNK_MODEL', '').strip(),
            'openrouter_embedding_model': os.getenv('OPENROUTER_EMBEDDING_MODEL', '').strip(),
